...
namespace DataAnalyzer
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void CombineButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            int[][] tempControlArrayInt = CustomArray.CreateCombinationsArray(combinationsShort, 4);

            // Create final array of five, four, three numbers
            int[][] controlDrawsArray = CustomArray.CreateIntArrayFromString(fileContent);

            int[][] tempControlArray = CustomArray.CompareArrays(controlDrawsArray, tempControlArrayInt, tempControlArrayInt.Length, 4, combFilter, CustomArray.EPurpose.control);
            //Filter array
            ...
            int[][] tempCombinationsArray = CustomArray.CompareArrays(tempCombinationsSixArrayInt, finalControlArrayFiltered, tempCombinationsSixArrayInt.Length, 6, combFilter, CustomArray.EPurpose.combinations);
            ...
            for (int i = 0; i < finalCombinationsArrayFiltered.Length; i++)
            {
                ...
                //For: 2 5 6 8 11 14 15 16 18 19 21 23 25 29 30 32
                if (
        ...
        private void PartialCombinationsButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            int[][] tempControlArrayInt = CustomArray.CreateCombinationsArray(combinationsFive, 4);

            // Create final array of five
            int[][] controlDrawsArray = CustomArray.CreateIntArrayFromString(fileContent);

            //Compare
            int[][] tempControlArray = CustomArray.CompareArrays(controlDrawsArray, tempControlArrayInt, tempControlArrayInt.Length, 5, combFilter, CustomArray.EPurpose.statistics);
